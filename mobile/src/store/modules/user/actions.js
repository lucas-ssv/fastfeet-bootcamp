...
export function reportProblemSuccess(order_id, description) {
    return {
        type: '@user/REPORT_PROBLEM_SUCCESS',
...
export function reportProblemFailure() {
    return {
        type: '@user/REPORT_PROBLEM_FAILURE',
    };
}

export function deliveryOrderSuccess(signature_id, order_id, deliveryman_id) {
    return {
        type: '@user/DELIVERY_ORDER_SUCCESS',
        payload: { signature_id, order_id, deliveryman_id },
    };
}

export function deliveryOrderFailure() {
    return {
        type: '@user/DELIVERY_ORDER_FAILURE',
    };
}
